...
export default function CallForPapers() {
  ...
  useEffect(() => {
    if (searchParams.get("show")) {
      const y =
        document.getElementById(searchParams.get("show")).getBoundingClientRect().top +
        window.scrollY-50;
      window.scroll({
        top: y,
        behavior: "smooth",
  ...
  return (
    <>
      ...
      <div className="row m-0 mt-5 p-0 align-items-center">
        <div className="row m-0 p-0" id="AIAndRobotics">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-2 ">
            <p className="fs-3 p-3">Artificial Intelligence and Robotics</p>
          </div>
        ...
        <div className="row m-0 p-0" id="BlockchainTechnology">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-7">
            <p className="fs-3">Blockchain Technology</p>
          </div>
        ...
        <div className="row m-0 p-0" id="CloudComputingAndVisualization">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-9 ">
            <p className="fs-3"> Cloud Computing and Visualization </p>
          </div>
        ...
        <div className="row m-0 p-0" id="CyberSecurity">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-6 ">
            <p className="fs-3 ">Cyber Security</p>
          </div>
        ...
        <div className="row m-0 p-0" id="DataScience">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-1 ">
            <p className="fs-3">Data Science</p>
          </div>
        ...
        <div className="row m-0 p-0" id="eCommerce">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-3">
            <p className="fs-3">E-Commerce</p>
          </div>
        ...
        <div className="row m-0 p-0" id="HighPerformingComputerArchitectures">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-6 ">
            <p className="fs-3">High Performing Computer Architectures </p>
          </div>
        ...
        <div className="row m-0 p-0" id="ImageAndVideoProcessing">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-11 ">
            <p className="fs-3">Image and Video Processing</p>
          </div>
        ...
        <div
          ...
          id="PandemicPrepardnessAndDigitalTehnology"
        >
          <div className="col-md-4 m-0 p-5 text-light nk-bg-25 ">
            <p className="fs-3"> Pandemic Prepardness and Digital Technology</p>
          </div>
        ...
        <div className="row m-0 p-0" id="PatternRecognizationAndClassification">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-26">
            <p className="fs-3">Pattern Recognization and Classification</p>
          </div>
        ...
        <div className="row m-0 p-0" id="NaturalLanguageProcessing">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-8 ">
            <p className="fs-3">Natural Language Processing</p>
          </div>
        ...
        <div className="row m-0 p-0" id="SoftwareEngineering">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-30">
            <p className="fs-3">Software Engineering</p>
          </div>
        ...
        <div className="row m-0 p-0" id="InternetOfThings">
          <div className="col-md-4 m-0 p-5 text-light nk-bg-31 ">
            <p className="fs-3">Internet of Things (IOT)</p>
          </div>
